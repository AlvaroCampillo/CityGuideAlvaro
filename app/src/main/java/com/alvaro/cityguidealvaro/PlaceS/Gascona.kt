...
class Gascona : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_gascona)

        play= findViewById(R.id.play)
        mediaPlayer=MediaPlayer.create(this,R.raw.gasconaaudio)

        play.setOnClickListener{
            onClick()
        }
        videoView=findViewById(R.id.videoView)
        videoPath="android.resource://"+ packageName +"/"+R.raw.gascona
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        getMenuInflater().inflate(R.menu.gascona, menu);
        return true;
    }
