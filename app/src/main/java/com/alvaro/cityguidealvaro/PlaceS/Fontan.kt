...
class Fontan : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fontan)

        play= findViewById(R.id.play)
        mediaPlayer= MediaPlayer.create(this,R.raw.fontanaudio)

        play.setOnClickListener{
            onClick()
        }
        videoView=findViewById(R.id.videoView)
        videoPath="android.resource://"+ packageName +"/"+R.raw.fontanvideo
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        getMenuInflater().inflate(R.menu.menu_fontan, menu);
        return true;
    }
