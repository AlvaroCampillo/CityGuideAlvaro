...
class StaMaria : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sta_maria)

        play= findViewById(R.id.play)
        mediaPlayer=MediaPlayer.create(this,R.raw.stamaria)

        play.setOnClickListener{
            onClick()
        }
        videoView=findViewById(R.id.videoView)
        videoPath="android.resource://"+ packageName +"/"+R.raw.stamariav
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        getMenuInflater().inflate(R.menu.stamaria, menu);
        return true;
    }
